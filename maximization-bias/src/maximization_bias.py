    ...
    while state != states['terminal']:
        ...
        # choose an action for Double Q-learning
            ...
            action = choose_action(
                action_value_estimates=([first_estimate + second_estimate for first_estimate, second_estimate in
        ...
        # for Double Q-learning, divide the time steps in 2, perhaps by flipping a coin on each step
            ...
            # get the best action
            best_action = np.random.choice([act for act,val in enumerate(update_estimate[next_state])])
